...
class ViewProfile extends StatefulWidget {
  ...
  @override
  State<ViewProfile> createState() => _SafeDeptViewProfileState();
}

class _SafeDeptViewProfileState extends State<ViewProfile> {
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        // Navigate back to SafeDeptViewProfile() page
